window.onload = function () {
    ...
    startBtn.onclick = function () {
        if (audioBlob) {
            ...
            const apiKey = 'AIzaSyCDvA-j10o8HeWZFJ7TbcdpSSRyxiwdd7w'; // 安全に管理する必要あり
            ...
            statusText.textContent = '音声ファイルを選択してください';
        }
    };

    // 文字起こし結果を表示
    function displayTranscription(transcription) {
        transcriptionBox.textContent = transcription; // 結果をボックスに表示
    }
